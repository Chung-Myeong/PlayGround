...
<h3> 평가자 </h3>
<ol>
  <li> 관리자가 제정한 SOP의 적합성을 평가한다. </li>
  <li> 평가자는 SOP를 평가할 수 있는 관리자 직급 혹은 그 이상의 직급 또는 해당 업무에 적합한 인물로 제한한다. </li>
</ol>
<p> 이들은 관리자가 제정한 SOP를 판단하는 역할을 가진다.
  해당 SOP가 부적합하다고 판단되는 경우, SOP 수정을 제안할 수 있으며 평가자 및 관리자의 과반수의 의견에 따라 제안이 받아들여진다.
</p>
